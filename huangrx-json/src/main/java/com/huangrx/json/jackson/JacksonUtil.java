...
public class JacksonUtil {
    ...
    public static <V> V parseUrl(URL url, Class<V> type) {
        try {
            ...
            throw new ApiException(String.format("jackson from error, url: %s, type: %s", url.getPath(), type), e);
        }
    }
    ...
    public static <V> V parseInputStream(InputStream inputStream, Class<V> type) {
        try {
            ...
            throw new ApiException(String.format("jackson from error, type: %s", type), e);
        }
    }
    ...
    public static <V> V parseFile(File file, Class<V> type) {
        try {
            ...
            throw new ApiException(String.format("jackson from error, file path: %s, type: %s", file.getPath(), type), e.getCause());
        }
    }
    ...
    public static <V> V parseFile(File file, TypeReference<V> type) {
        try {
            ...
            throw new ApiException(String.format("jackson from error, file path: %s, type: %s", file.getPath(), type), e);
        }
    }
    ...
    public static <V> V parseString(String json, Type type) {
        ...
        try {
            ...
            throw new ApiException(String.format("jackson from error, json: %s, type: %s", json, type), e);
        }
    }
    ...
    public static Map<String, Object> parseStringToMap(String json) {
        ...
        try {
            ...
            throw new ApiException(String.format("jackson from error, json: %s", json), e);
        }
    }
    ...
    public static <V> String toJson(V v) {
        try {
            ...
            throw new ApiException(String.format("jackson to error, data: %s", v), e);
        }
    }
    ...
    public static <V> String toJson(List<V> list) {
        try {
            ...
            throw new ApiException(String.format("jackson to error, data: %s", list), e);
        }
    }
    ...
    public static <V> String toJson(Map<String, V> map) {
        try {
            ...
            throw new ApiException(String.format("jackson to error, data: %s", map), e);
        }
    }
    ...
    public static <V> void toJson(String path, List<V> list) {
        try (Writer writer = new FileWriter(path, true)) {
            ...
            throw new ApiException(String.format("jackson to file error, path: %s, list: %s", path, list), e);
        }
    }
    ...
    public static <V> void toJson(String path, V v) {
        try (Writer writer = new FileWriter(path, true)) {
            ...
            throw new ApiException(String.format("jackson to file error, path: %s, data: %s", path, v), e);
        }
    }
